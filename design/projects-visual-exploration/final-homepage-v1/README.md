# VDVXDV Projects — Final Homepage v1

This folder contains the final-polish Projects homepage prototype. Open `index.html` through a local HTTP server; no build step or external dependency is required.
